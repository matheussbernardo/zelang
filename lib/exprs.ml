...
let rec exprS_of_sexp s =
  ...
  | List [Atom "let"; List [ Atom id; body ];  e] -> LetS (id, exprS_of_sexp body, exprS_of_sexp e)
  | List [ op; l; r ] ->
...
let rec sexp_of_exprS t =
  ...
  | IdS i -> Atom i
  | LetS (id, body, e) -> List [Atom "let"; List [ Atom id; sexp_of_exprS body ]; sexp_of_exprS e]
